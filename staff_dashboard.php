...
<div class="container">
    ...
    <div class="dashboard">
        <div class="card">
            ...
            <p>4</p> <!-- Replace with dynamic count -->
        </div>
        <div class="card">
            <div class="card-icon">📅</div>
            <h3>Table Bookings</h3>
            <p>8</p> <!-- Replace with dynamic count -->
        </div>
    </div>

    <!-- Quick Links Section -->
    <ul class="links">
        <li><a href="assigned_orders.php">📝 View Assigned Orders</a></li>
        <li><a href="table_bookings.php">📅 View Table Bookings</a></li>
        <li><a class="logout" href="logout.php">🚪 Logout</a></li>
    </ul>
</div>
